...
<?php  
    ...
    <?php $article_link = get_permalink(); // Récupère le lien de l'article ?>
        <div class="post-thumbnail">
            <div class="post-thumbnail-overlay">
                ...
                <a href="<?php echo esc_url( $article_link ); ?>">
                    <svg class="eye-overlay" xmlns="http://www.w3.org/2000/svg" width="46" height="32" viewBox="0 0 46 32" fill="none">
...
<?php
    endwhile;
        ...
        echo '<p>Aucune autre photo dans cette catégorie.</p>';
endif;
wp_reset_postdata();
?>
</div>